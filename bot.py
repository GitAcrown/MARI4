...
logger = logging.getLogger('MARI4.Main')
...
async def main():
    ...
    async with bot:
        ...
        async def on_ready():
            ...
            # Enregistrer les outils une fois que tous les cogs sont chargés
            ...
            if chat_cog and hasattr(chat_cog, '_register_tools_from_cogs'):
                ...
                logger.info("Outils enregistrés après chargement de tous les cogs")
